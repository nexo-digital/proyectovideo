...
<html >
     ...
     <head>
	   ...
	   <title>Formulario Contacto Administración</title>
...
$result = mysqli_query($mysqli,"SELECT * FROM contacto");
...
echo "<td><a href='Acciones/EliminarContacto.php?id=".$row['id_contacto']."'><img src='./imagenes/eliminar.png' alt='Eliminar'></a></td><tr>";
